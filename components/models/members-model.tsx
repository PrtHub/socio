          ...
          {server?.members?.map((member) => (
            <section key={member.id} className="flex items-center gap-x-2 mb-6">
              ...
              <div className="flex flex-col gap-y-1">
                <div className="text-xs semibold-text flex items-center">
                  {member.profile.name}
                  ...
                  <div className="ml-auto">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <MoreVertical className="size-4 text-zinc-400 cursor-pointer" />
                      </DropdownMenuTrigger>
              ...
              {loadingId === member.id && (
                <Loader2 className="ml-auto size-4 text-zinc-400 animate-spin" />
              )}
            </section>
          ))}
        </ScrollArea>
